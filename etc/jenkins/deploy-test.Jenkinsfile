...
pipeline {
    ...
    stages {
        ...
        stage('Create .env file') {
            steps {
                configFileProvider(
                    [configFile(fileId: 'atesmaps-api-env-test', variable: 'ENV_FILE')]) {
                    sh 'cat $ENV_FILE > .env'
                }
            }
        }
                ...
                script {
                    ...
                    withCredentials([
                        usernamePassword(
                            ...
                            sshCommand remote: remote, command: "docker stop atesmaps-api"
                            sshCommand remote: remote, command: "docker rm atesmaps-api"
